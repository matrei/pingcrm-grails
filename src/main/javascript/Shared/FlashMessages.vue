...
<template>
  <div>
    <div v-if="flash.success && show" class="mb-8 flex items-center justify-between bg-green-500 rounded max-w-3xl">
    ...
    <div v-if="(flash.error || Object.keys(errors).length > 0) && show" class="mb-8 flex items-center justify-between bg-red-400 rounded max-w-3xl">
      <div class="flex items-center">
