 ...
 * As this application is supposed to run openly as a demo where anyone is allowed to log we need this prevention
 * or anyone could delete the demo user and prevent the next person to log in.
 */
@CompileStatic
